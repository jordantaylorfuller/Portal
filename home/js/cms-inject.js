(async () => {
  ...
  // Runtime poster sync — DB is the single source of truth. Fetch each editor's
  // public reel and replace any baked poster URLs that have changed since the
  // last works.json regeneration.
